  ...
  return (
    <main className="seismic-safe-page min-h-screen bg-[#f5f7f8] text-slate-950 selection:bg-[#c8dded]">
      <header className="border-b border-slate-200 bg-white/85 backdrop-blur">
        <div className="seismic-app-header-inner mx-auto flex max-w-5xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
